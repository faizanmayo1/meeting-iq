...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        "display": ["2.5rem", { lineHeight: "2.75rem", letterSpacing: "-0.025em", fontWeight: "600" }],
        "h1": ["2rem", { lineHeight: "2.35rem", letterSpacing: "-0.022em", fontWeight: "600" }],
        "h2": ["1.5rem", { lineHeight: "1.85rem", letterSpacing: "-0.018em", fontWeight: "600" }],
        "h3": ["1.125rem", { lineHeight: "1.55rem", letterSpacing: "-0.012em", fontWeight: "600" }],
        "body-lg": ["1rem", { lineHeight: "1.5rem" }],
        "body": ["0.875rem", { lineHeight: "1.4rem" }],
        "body-sm": ["0.8125rem", { lineHeight: "1.25rem" }],
        "caption": ["0.75rem", { lineHeight: "1rem", letterSpacing: "0.06em", fontWeight: "500" }],
        "kpi": ["2.25rem", { lineHeight: "2.4rem", letterSpacing: "-0.025em", fontWeight: "600" }],
        "kpi-sm": ["1.5rem", { lineHeight: "1.75rem", letterSpacing: "-0.02em", fontWeight: "600" }],
      },
      borderRadius: {
        sm: "0.25rem",
        md: "0.375rem",
